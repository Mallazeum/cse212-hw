...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: The enqueue function was placing any new people at location 0 rather than adding them to the end of the list
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: There was no case checking for if a person had 0 or less turns to requeue them 
    // I added an else if statement to check if they had 0 or less turns that would requeue them if so.
